...
POLL_FREQUENCY = 300  # how often to update data in milliseconds
...
col1 = [
    ...
    [sg.Text('', size=(6, 1), key='_lastprice_', text_color=sg.theme_background_color())],
    [sg.T('当前价')]
]
...
while True:
    ...
    window['_lastprice_'].update(lastprice, background_color=background_color)
